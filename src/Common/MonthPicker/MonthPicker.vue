    ...
    isInSelectedRange(monthIndex) {
      ...
      if (!isOverMultipleYears) {
        ...
        return (
          ...
          (isStartMonthOrAfter && this.year === this.firstRangeMonthYear) ||
          (isEndMonthOrBefore && this.year === this.secondRangeMonthYear)
        );
      }
    },
...
.month-picker__month.selected-range-second {
  ...
  border-radius: 5px;
  box-shadow:
    inset 0 0 3px #3490d2,
    0px 2px 5px rgba(85, 176, 242, 0.2);
